...
<body>
   ...
   try
   {
       ...
       String sql1="select i.incident_id,i.cust_id,c.policy_number,i.incident_cost,i.incident_type,i.incident_report_description from incident_report as i,claim as c where i.incident_id=c.incident_id and claim_status=?";
...
<div class="container px-4 py-5 outer_box"  id="icon-grid">
    ...
    <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Incident_id:</h3>
      ...
      <div class="col d-flex align-items-start">
        <svg class="bi text-body-secondary flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#bootstrap"></use></svg>
        <div>
          <h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Cust Id:</h3>
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Incident Cost: </h3>
          <p><%= rs1.getString("incident_cost") %></p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        ...
        <div>
          ...
          <p> <%= rs1.getString("incident_type") %></p>
        </div>
      </div>
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Description: </h3>
          <p><%= rs1.getString("incident_report_description") %></p>
        </div>
        <a href="setting_attributes_to_claim_settlement_form?incident_id=<%= rs1.getString("incident_id") %>" class="custom_dark-btn" >
                report
              </a>
      </div>
